...
import okIcon from 'assets/icon/tick_24px.png';
import returnProductIcon from 'assets/icon/returns_24px.png';
  ...
  return (
    <div className="bg-white p-12 policy">
      ...
      <div className="m-b-12">
        <img src={tickIcon} className="m-r-4" />
      ...
      <div className="m-b-12">
        <img src={returnsIcon} className="m-r-4" />
