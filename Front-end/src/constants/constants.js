...
const TRANSPORT_METHOD_OPTIONS = [
  { value: 0, label: 'Giao hàng tiêu chuẩn', price: 35000 },
  { value: 1, label: 'Giao hàng tiết kiệm', price: 20000 },
  { value: 2, label: 'Giao hàng nhanh', price: 700000 },
];

// product type options
const PRODUCT_TYPES = [
  { type: 0, label: 'Sữa rửa mặt' },
  { type: 1, label: 'Sữa tắm' },
  { type: 2, label: 'Tẩy trang' },
  { type: 3, label: 'Toner' },
  { type: 4, label: 'Tẩy tế bào chết' },
  { type: 5, label: 'Serum' },
  { type: 6, label: 'Kem dưỡng' },
  { type: 7, label: 'Xịt khoáng' },
  { type: 8, label: 'Nước hoa' },
  { type: 9, label: 'Màn hình' },
  { type: 10, label: 'Kẻ mắt' },
  { type: 11, label: 'Phấn tạo khối' },
  { type: 12, label: 'Phấn má hồng' },
];
