...
import Category from './AllProduct/category';
      ...
      <Row className="container">
        ...
        <Col span={24} className="adv box-sha-home bor-rad-8 m-b-32">
          <a >
            <img
              ...
              src="https://icms-image.slatic.net/images/ims-web/d8701ca7-4504-43ac-bfe1-10c4c0ad39ca.jpg"
            />
          </a>
        </Col>
        <Col className="m-tb-32" span={24}>
        ...
        <Col span={24} className="adv box-sha-home bor-rad-8 m-b-32">
          <a>
            <img
              className="adv-img w-100 bor-rad-8"
              src="https://cf.shopee.vn/file/bff4b9ff99dcd7d75723fe713a894e61"
            />
          </a>
        </Col>
