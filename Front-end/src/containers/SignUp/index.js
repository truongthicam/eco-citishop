            ...
            <Form className="bg-form m-t-20">
              <Row
                ...
                <Col className="p-b-0" span={24} md={12}>
                  <Row gutter={[0, 16]}>
                    <h1 className="Signup-title m-b-20 m-t-20"><b>Đăng ký</b></h1>
                    <Col span={20}>
                      {/* email field */}
                      <FastField
                        name="email"
                    ...
                    <Col span={24}>
                      ...
                      <FastField
                        ...
                        size="large"
                        suffix={
                          <Tooltip title="Nhập mã đã gửi qua email">
                            <InfoCircleOutlined
                              style={{ color: suffixColor }}
                            />
                          </Tooltip>
                    ...
                    <Col span={24} className="p-t-0 t-center">
                      ...
                      <div className="m-t-5 font-weight-500">
                        Bạn đã có tài khoản ?
                ...
                <Col className="p-b-0" span={24} md={12}>
                  <h1><br/></h1>
                  <img src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.15752-9/258761902_1733599173500022_6437953607053960409_n.png?_nc_cat=100&ccb=1-5&_nc_sid=ae9488&_nc_ohc=j-il2rGf1ywAX-Jk-Q2&_nc_ht=scontent.fdad3-3.fna&oh=ef9b36ce07f1c3bff83931392c7de3b5&oe=61CE6D12" alt="logo" width="580" height="480"/>
