...
const menuList = [
  ...
  },
  {
    ...
    children: [
      { key: 'p0', title: 'Xem sản phẩm',},
      { key: 'p1', title: 'Thêm sản phẩm',},
    ],
  },
  {
    key: 'c',
    ...
    <div className="Admin-Page" style={{ backgroundColor: '#e5e5e5' }}>
      {!isLogin ? (
        <div className="trans-center bg-white p-32 bor-rad-8 box-sha-home">
          <h2 className="m-b-16 t-center">Đăng nhập quyền Admin</h2>
          ...
          <div
            ...
            <div className="flex-grow-1 d-flex align-i-center">
              ...
              <a
                ...
                />
                <span className="open-web-title"></span>
              </a>
